...
def run_backup(args) -> None:
    """Create a zip backup of the Charterforge home directory."""
    hermes_root = get_default_hermes_root()

    if not hermes_root.is_dir():
        print(f"Error: Charterforge home directory not found at {hermes_root}")
        sys.exit(1)
...
def _validate_backup_zip(zf: zipfile.ZipFile) -> tuple[bool, str]:
    """Check that a zip looks like a Charterforge backup.
    ...
    if not found:
        return False, (
            "zip does not appear to be a Charterforge backup "
...
def run_import(args) -> None:
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if (has_config or has_env) and not args.force:
            print()
            print("Warning: Target directory already has Charterforge configuration.")
        ...
        print("Done. Your Charterforge configuration has been restored.")
...
def restore_cron_jobs_if_emptied(
    ...
    Args:
        ...
        hermes_home: Override for the Charterforge home directory (tests).
