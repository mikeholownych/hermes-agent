...
def _default_spawn(
    ...
    *,
    ...
    # back to Path.home() / ".charterforge" (the DEFAULT profile root), ignoring
    # the profile-specific config entirely.  Fixes profile-scoped
    # fallback_providers being invisible to kanban workers.
