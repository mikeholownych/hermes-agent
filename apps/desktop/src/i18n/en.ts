...
export const en: Translations = {
  ...
  boot: {
    ready: 'Charterforge Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Charterforge settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingCharterforgeDesktop: 'Starting Charterforge Desktop…'
    },
    errors: {
      backgroundExited: 'Charterforge background process exited.',
      backgroundExitedDuringStartup: 'Charterforge background process exited during startup.',
    ...
    failure: {
      title: "Charterforge couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Charterforge backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Charterforge Desktop.',
    ...
    native: {
      ...
      inputBody: 'Charterforge is waiting for your response.',
      turnDoneTitle: 'Charterforge finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Charterforge defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Charterforge writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Charterforge is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Charterforge asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Charterforge was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    searchPlaceholder: {
      about: 'About Charterforge Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Charterforge follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Charterforge is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Charterforge, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Charterforge checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Charterforge configuration...',
    ...
    gateway: {
      ...
      intro:
        'Charterforge Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Charterforge backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset CHARTERFORGE_DESKTOP_REMOTE_URL and CHARTERFORGE_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Charterforge backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Charterforge backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Charterforge Cloud',
      cloudDesc: 'Sign in once to Charterforge Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Charterforge Cloud',
      cloudSignIn: 'Sign in to Charterforge Cloud',
      cloudSignedIn: 'Signed in to Charterforge Cloud',
      cloudNeedsSignIn: 'Sign in to Charterforge Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Charterforge Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Charterforge Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Charterforge Cloud',
      cloudSignedOutMessage: 'Cleared the Charterforge Cloud session.',
      ...
      restartingMessage: 'Charterforge Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Charterforge ${version}` : ''}`,
      ...
      sshDesc:
        'Charterforge is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshCharterforgePathTitle: 'Charterforge path (optional)',
      sshCharterforgePathDesc: 'Full path to the remote hermes binary. Blank = auto-detect.',
      sshCharterforgePathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Charterforge found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Charterforge runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Charterforge is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Charterforge path.',
      sshErrPlatform:
        'Unsupported remote platform. Charterforge Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Charterforge on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Charterforge runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Charterforge at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Charterforge builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Charterforge to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Charterforge to generate pets.',
      backgroundHint: 'You can close this — Charterforge will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Charterforge desktop' },
    ...
    hermesActiveSessions: (version, count) => `Charterforge ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Charterforge environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Charterforge will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Charterforge...',
    placeholderReconnecting: 'Reconnecting to Charterforge…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Charterforge a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Charterforge will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Charterforge to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Charterforge…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Charterforge…',
    ...
    unsupportedMessage: 'This version of Charterforge can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Charterforge is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Charterforge backend is ready to install.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Charterforge desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Charterforge updater takes over in its own window and reopens Charterforge automatically when it’s done. Please don’t reopen Charterforge yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Charterforge reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Charterforge reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Charterforge needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Charterforge Desktop',
    setupChoiceDesc:
      'Connect this app to a Charterforge gateway you already run, or install Charterforge locally on this computer.',
    connectExistingTitle: 'Connect to existing Charterforge',
    ...
    installLocalTitle: 'Install Charterforge locally',
    ...
    probeError: 'Could not reach that Charterforge gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Charterforge',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Charterforge CLI or desktop instance is running. Stop any running Charterforge instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Charterforge installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Charterforge",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Charterforge is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Charterforge…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Charterforge',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Charterforge connects automatically',
    ...
    authorizeThere: 'Authorize Charterforge there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Charterforge there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Charterforge Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Connected to Charterforge Cloud at ${host} · click to manage`,
      ...
      gatewayTitle: 'Charterforge inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Charterforge will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Charterforge is restarting...',
      askRestart: 'Ask Charterforge to restart the server',
      lookingRestart: taskId => `Charterforge is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Charterforge is working in the background. Watch the preview console for progress.',
      ...
      restartFailedMessage: 'Charterforge could not restart the server.',
      stillWorking:
        'Charterforge is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Charterforge is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Charterforge gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Charterforge won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Charterforge needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Charterforge needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Charterforge Desktop to use Save Image.',
    restartToSaveImages: 'Restart Charterforge Desktop to save images',
