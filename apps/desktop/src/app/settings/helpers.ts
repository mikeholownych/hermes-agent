...
import type { CharterforgeConfigRecord, ConfigFieldSchema, ToolsetInfo } from '@/types/hermes'
...
export function getNested(obj: CharterforgeConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function sectionFieldEntries(
  ...
  config: CharterforgeConfigRecord
...
export function setNested(obj: CharterforgeConfigRecord, path: string, value: unknown): CharterforgeConfigRecord {
...
function personalityOptions(config: CharterforgeConfigRecord): string[] {
...
function commandProviderNames(config: CharterforgeConfigRecord, section: 'tts' | 'stt'): string[] {
