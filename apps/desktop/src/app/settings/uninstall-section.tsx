...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Charterforge agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Charterforge agent, and all of your config, chats, secrets, and logs',
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Charterforge</p>
